    ...
    public static class MyVisitor extends SysYParserBaseVisitor<LLVMValueRef>{
        ...
        public LLVMValueRef visitLVal(SysYParser.LValContext ctx) {
            ...
            if(ctx.exp().size() == 0){
                ...
                LLVMValueRef value = LLVMBuildLoad(builder, pointer, /*varName:String*/name+symbol.getUsedTime());
                return value;
            }else{
                ...
                LLVMValueRef value = LLVMBuildLoad(builder, res, name+symbol.getUsedTime());
                return value;
            }
        }
